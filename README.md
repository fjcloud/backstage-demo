...
Fork the following repo `https://github.com/fjcloud/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/fjcloud/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/fjcloud/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/rosa.fja-hcp.4j9x.p3.openshiftapps.com/${base_domain}/g" {} +
git add -A
...
Fork the following repo `https://github.com/fjcloud/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/fjcloud/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/fjcloud/backstage-app-demo` to your organization.
